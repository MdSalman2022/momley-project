...
const BookDetails = () => {
  ...
  const { data: bookDetails = [], isLoading } = useQuery(["bookDetails"], () =>
    fetch(`${import.meta.env.VITE_SERVER_URL}/api/get/book/${id}`, {
      method: "GET",
      headers: {
        ...
        <div className="col-span-3 grid grid-cols-2 gap-5">
          <div className="flex col-span-2 w-full gap-10">
            <div className="flex flex-col gap-5">
              <img
                className="object-cover w-full md:w-fit lg:w-[360px] h-full"
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-5">
                <div className="primary-outline-btn w-40 flex justify-center">
                  Add to cart
                </div>
                <div className="primary-btn w-40 flex justify-center">
                  Buy Now
                </div>
              </div>
          ...
          <div className="col-span-2 flex flex-col py-10">
            ...
            <div className="flex flex-col gap-5 mr-2">
              <p>
                ...
                Dignissimos in non doloribus facilis repellendus beatae nam ipsa
                vitae cum ad, eum nemo accusamus maiores voluptas, vel dolore
                veniam sunt. Repudiandae impedit, fugit laudantium ipsam, sint
                explicabo quaerat nam officiis eum ad enim, consequatur
                inventore accusamus! Necessitatibus accusamus neque ex
                blanditiis.
              </p>
              ...
              <p>
                ...
                numquam, tempore facere nobis nesciunt tenetur dolor laudantium
                culpa commodi? Eius impedit, delectus veniam, veritatis eaque
                maxime non atque ullam minus ut quia deserunt ex amet quo et
                neque alias nesciunt, asperiores voluptates itaque?
                Reprehenderit nostrum libero eos voluptatum delectus commodi.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="flex flex-col justify-between gap-3">
                ...
                <div className="flex items-center rounded-sm justify-between border border-black">
                  <span className="flex items-center rounded-sm-l border-black justify-center w-12 h-10 border-r">
                    <FaMinus />
                  </span>
                  <span className="flex items-center justify-center w-12 h-10 ">
                    1
                  </span>
                  <span className="flex items-center rounded-sm-r border-black justify-center bg-gray-500 text-white w-12 h-10 border-l">
                    <FaPlus />
                  </span>
                </div>
              </div>
              <div className="flex flex-col justify-between col-span-2 gap-2">
                ...
                <button className="primary-outline-btn flex items-center justify-center rounded-sm">
